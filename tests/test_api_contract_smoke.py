...
def test_core_contract_routes_are_registered() -> None:
    ...
    expected = {
        ...
        ("POST", "/api/v1/forge/sync/load"),
        ("GET", "/api/v1/forge/builds"),
        ("POST", "/api/v1/forge/builds"),
        ("GET", "/api/v1/forge/builds/{build_id}"),
        ("PATCH", "/api/v1/forge/builds/{build_id}"),
        ("POST", "/api/v1/forge/builds/{build_id}/publish"),
        ("POST", "/api/v1/forge/builds/{build_id}/resync"),
        ("POST", "/api/v1/forge/builds/{build_id}/fetch"),
        ("GET", "/api/v1/forge/builds/{build_id}/fetch/status"),
        ("GET", "/api/v1/forge/fetch/runs"),
        ("GET", "/api/v1/forge/fetch/runs/{run_id}"),
        ("GET", "/api/v1/forge/fetch/runs/{run_id}/tasks"),
        ("POST", "/api/v1/forge/fetch/runs/{run_id}/retry"),
        ("GET", "/api/v1/library/playlists"),
        ("GET", "/api/v1/library/playlists/{playlist_id}/tracks"),
        ("POST", "/api/v1/library/playlists/{playlist_id}/tracks"),
        ("POST", "/api/v1/library/playlists/sync"),
        ("PATCH", "/api/v1/library/playlists/{playlist_id}"),
        ("GET", "/api/v1/library/artists"),
        ("GET", "/api/v1/library/releases"),
        ("GET", "/api/v1/library/albums"),
        ("POST", "/api/v1/library/albums/{album_id}/cover"),
