...
-- Cached public artist top tracks (Deezer).
CREATE TABLE IF NOT EXISTS lib_artist_top_tracks_cache (
    artist_deezer_id TEXT PRIMARY KEY,
    tracks_json      TEXT NOT NULL,              -- raw list from /artist/{id}/top
...
-- Tier 2 - Rebuildable: pre-publish Build artifacts for Builder workflow
...
-- Tier 2 - Rebuildable: Custom Discovery artist candidate cache
...
-- Tier 2 - Rebuildable: Custom Discovery track candidate cache
...
-- Tier 3 - Persistent: run ledger for Custom Discovery
...
-- Tier 3 - Persistent: selected track history to avoid weekly repeats
