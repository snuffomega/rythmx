...
interface NewMusicConfigFormProps {
        ...
        {advanced && (
          <div className="mt-5 space-y-5">
                ...
                {(['album', 'single', 'ep'] as const).map(kind => {
                  ...
                  return (
                    <label key={kind} className="flex items-center gap-1.5 cursor-pointer text-sm text-text-muted hover:text-text-secondary transition-colors select-none">
                      <input type="checkbox" checked={checked} onChange={toggleKind} className="accent-accent w-3.5 h-3.5 cursor-pointer" />
            ...
            <div>
              ...
              <p className="text-[#444] text-xs mt-1">Appends the date — e.g. "New Music — Jan 2026"</p>
            </div>
            <div>
